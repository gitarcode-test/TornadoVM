...
/**
 * The unit-tests in this class implement some Reduction operations (add, max, min) for {@link
 * Integer} type. These unit-tests check the functional operation of some {@link KernelContext}
 * features, such as global thread identifiers, local thread identifiers, the local group size of
...
public class TestReductionsIntegersKernelContext extends TornadoTestBase {
  ...
  public void basic() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0", TestReductionsIntegersKernelContext::basicAccessThreadIds, context, input) //
    ...
    for (int i = 0; i < size; i++) {
      assertThat(i, equalTo(input.get(i)));
    }
  }
  ...
  public void basic02() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::basicAccessThreadIds02,
                context,
                input,
                output) //
    ...
    for (int i = 0; i < size; i++) {
      assertThat(input.get(i), equalTo(output.get(i)));
    }
  }
  ...
  public void basic03() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::basicAccessThreadIds03,
                context,
                input,
                output) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, output);
    ...
    for (int i = 0; i < size; i++) {
      assertThat(input.get(i) * 2, equalTo(output.get(i)));
    }
  }
  ...
  public void basic04() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::basicAccessThreadIds04,
                context,
                input,
                output) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, output);
    ...
    for (int i = 0; i < size; i++) {
      assertThat((double) 2f, closeTo(output.get(i), 0.0));
    }
  }
  ...
  public void basic05() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::basicAccessThreadIds05,
                context,
                input,
                output) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, output);
  ...
  public void testIntReductionsAddGlobalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::intReductionAddGlobalMemory,
                context,
                input,
                reduce) //
  ...
  @Test
  public void testIntReductionsAddLocalMemory() throws TornadoExecutionPlanException {
    final int size = 256;
    final int localSize = 256;
    IntArray input = new IntArray(size);
    IntArray reduce = new IntArray(size / localSize);
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::intReductionAddLocalMemory,
                context,
                input,
                reduce) //
    ...
    assertThat(sequential, equalTo(finalSum));
  }
  ...
  public void testIntReductionsMaxGlobalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::intReductionMaxGlobalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testIntReductionsMaxLocalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::intReductionMaxLocalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testIntReductionsMinGlobalMemory() throws TornadoExecutionPlanException {
    ...
    IntStream.range(0, input.getSize())
        .sequential()
        .forEach(i -> input.set(i, r.nextInt(10000000)));
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::intReductionMinGlobalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testIntReductionsMinLocalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsIntegersKernelContext::intReductionMinLocalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
