...
/**
 * The unit-tests in this class implement some Reduction operations (add, max, min) for {@link Long}
 * type. These unit-tests check the functional operation of some {@link KernelContext} features,
 * such as global thread identifiers, local thread identifiers, the local group size of the
...
public class TestReductionsLongKernelContext extends TornadoTestBase {
  ...
  private static void longReductionMaxGlobalMemory(
      KernelContext context, LongArray a, LongArray b) {
    int localIdx = context.localIdx;
    int localGroupSize = context.localGroupSizeX;
    int groupID = context.groupIdx; // Expose Group ID
    int id = localGroupSize * groupID + localIdx;
  ...
  private static void longReductionMinGlobalMemory(
      KernelContext context, LongArray a, LongArray b) {
    int localIdx = context.localIdx;
    int localGroupSize = context.localGroupSizeX;
    int groupID = context.groupIdx; // Expose Group ID
  ...
  public void testLongReductionsAddGlobalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("taskGraph") //
            ...
            .task(
                "t0",
                TestReductionsLongKernelContext::longReductionAddGlobalMemory,
                context,
                input,
                reduce) //
  ...
  public void testLongReductionsAddLocalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("taskGraph") //
            ...
            .task(
                "t0",
                TestReductionsLongKernelContext::longReductionAddLocalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testLongReductionsMaxGlobalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("taskGraph") //
            ...
            .task(
                "t0",
                TestReductionsLongKernelContext::longReductionMaxGlobalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testLongReductionsMaxLocalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("taskGraph") //
            ...
            .task(
                "t0",
                TestReductionsLongKernelContext::longReductionMaxLocalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testLongReductionsMinGlobalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("taskGraph") //
            ...
            .task(
                "t0",
                TestReductionsLongKernelContext::longReductionMinGlobalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testLongReductionsMinLocalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("taskGraph") //
            ...
            .task(
                "t0",
                TestReductionsLongKernelContext::longReductionMinLocalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
