...
public class TestSlice extends TornadoTestBase {
  ...
  public void testFloatArraySlice() {
    ...
    for (int i = 0; i < slice.getSize(); i++) {
      assertThat("Mismatch in second part of slice", (double) 5.0f, closeTo(slice.get(i), 0.0f));
    }
  }
  ...
  public void testDoubleArraySlice() {
    ...
    for (int i = 0; i < slice.getSize(); i++) {
      assertThat("Mismatch in second part of slice", (double) 5.0d, closeTo(slice.get(i), 0.0f));
    }
  }
  ...
  public void testByteArraySlice() {
    ...
    for (int i = 0; i < slice.getSize(); i++) {
      assertThat("Mismatch in second part of slice", (double) 5.0, closeTo(slice.get(i), 0.0f));
    }
  }
  ...
  public void testHalfFloatArraySlice() {
    ...
    for (int i = 0; i < slice.getSize(); i++) {
      assertThat("Mismatch in second part of slice", (double) 5.0d, closeTo(slice.get(i).getFloat32(), 0.0f));
    }
  }
}
