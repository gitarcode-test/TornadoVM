...
public class GraphicsTests extends TornadoTestBase {
  ...
  public void testVolumeGrad() {
    ...
    for (int i = 0; i < output.getLength(); i++) {
      ...
      MatcherAssert.assertEquals("difference on index " + i + " s0", s.getS0(), o.getS0(), 0.01f);
      MatcherAssert.assertEquals("difference on index " + i + " s1", s.getS1(), o.getS1(), 0.01f);
      MatcherAssert.assertEquals("difference on index " + i + " s2", s.getS2(), o.getS2(), 0.01f);
    }
  }
  ...
  public void testRenderVolume() {
    ...
    for (int i = 0; i < output.X(); i++) {
      for (int j = 0; j < output.Y(); j++) {
        ...
        MatcherAssert.assertEquals("index = " + i + ", " + j, s.getX(), o.getX());
        MatcherAssert.assertEquals("index = " + i + ", " + j, s.getY(), o.getY());
        MatcherAssert.assertEquals("index = " + i + ", " + j, s.getZ(), o.getZ());
        MatcherAssert.assertEquals("index = " + i + ", " + j, s.getW(), o.getW());
      }
    }
  }
