...
public class Grids extends TornadoTestBase {
  ...
  private static void psKernel(
      KernelContext kc, FloatArray tArray, FloatArray vArray, FloatArray results) {
    int idx = kc.localIdx;
  ...
  public void testWithCorrectNames() throws TornadoExecutionPlanException {
    ...
    taskGraph
        .transferToDevice(DataTransferMode.EVERY_EXECUTION, timesArray, obsArray) //
