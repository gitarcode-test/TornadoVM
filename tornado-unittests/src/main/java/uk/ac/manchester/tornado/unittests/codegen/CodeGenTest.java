...
public class CodeGenTest extends TornadoTestBase {
  ...
  public static void cascadeKernel(
      IntArray grayIntegralImage, int imageWidth, int imageHeight, IntArray resultsXY) {
  ...
  public void test01() throws TornadoExecutionPlanException {
    ...
    taskGraph
        .transferToDevice(DataTransferMode.FIRST_EXECUTION, grayIntegralImage) //
        .task(
            "bar",
            CodeGenTest::cascadeKernel,
            grayIntegralImage,
            imageWidth,
            imageHeight,
            resultsXY) //
