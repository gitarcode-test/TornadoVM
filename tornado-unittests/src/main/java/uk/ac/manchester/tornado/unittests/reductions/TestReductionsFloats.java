...
public class TestReductionsFloats extends TornadoTestBase {
  ...
  public void testSumFloatsLarge() throws TornadoExecutionPlanException {
    ...
    // Check result
    assertThat(sequential.get(0), closeTo(result.get(0), 1.f));
  }
  ...
  private static void reductionAddFloats4(
      FloatArray inputA, FloatArray inputB, @Reduce FloatArray result) {
    float error = 2f;
    result.set(0, 0.0f);
  ...
  public void testComputePi() throws TornadoExecutionPlanException {
    ...
    assertThat(3.14, closeTo(piValue, 0.01f));
  }
  ...
  private static void minReductionAnnotation(
      FloatArray input, @Reduce FloatArray result, float neutral) {
  ...
  public void testMinReduction() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsFloats::minReductionAnnotation,
                input,
                result,
                Float.MAX_VALUE) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, result);
  ...
  public void testMinReduction2() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsFloats::minReductionAnnotation2,
                input,
                result,
                Float.MAX_VALUE) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, result);
  ...
  public static void integrationTornado(
      FloatArray input, @Reduce FloatArray sum, final float a, final float b) {
  ...
  public void testIntegrate() throws TornadoExecutionPlanException {
    ...
    assertThat(finalValueSeq, closeTo(finalValueTornado, 0.01f));
  }
}
