...
/**
 * Test to check TornadoVM is able to bailout to the Java sequential implementation if there are
 * errors during optimizations phases, code generation, or runtime.
 *
 * <p>How to run? <code>
...
public class CodeFail extends TornadoTestBase {
  ...
  /**
   * Object allocation is not supported. This test provokes to bailout to the Java sequential
   * implementation.
   */
  ...
  /**
   * Fusion of multiple reductions is not currently supported. This test provokes to bailout to the
