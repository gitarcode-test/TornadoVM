 ...
 * Float} type. These unit-tests check the functional operation of some {@link KernelContext}
...
public class TestReductionsFloatsKernelContext extends TornadoTestBase {
  ...
  public static void floatReductionAddGlobalMemory(
      KernelContext context, FloatArray a, FloatArray b) {
  ...
  public static void floatReductionAddLocalMemory(
      KernelContext context, FloatArray a, FloatArray b) {
  ...
  private static void floatReductionMaxGlobalMemory(
      KernelContext context, FloatArray a, FloatArray b) {
    int localIdx = context.localIdx;
    int localGroupSize = context.localGroupSizeX;
    int groupID = context.groupIdx; // Expose Group ID
  ...
  public static void floatReductionMaxLocalMemory(
      KernelContext context, FloatArray a, FloatArray b) {
    int globalIdx = context.globalIdx;
    int localIdx = context.localIdx;
    int localGroupSize = context.localGroupSizeX;
  ...
  private static void floatReductionMinGlobalMemory(
      KernelContext context, FloatArray a, FloatArray b) {
    int localIdx = context.localIdx;
    int localGroupSize = context.localGroupSizeX;
    int groupID = context.groupIdx; // Expose Group ID
  ...
  public static void floatReductionMinLocalMemory(
      KernelContext context, FloatArray a, FloatArray b) {
    int globalIdx = context.globalIdx;
    int localIdx = context.localIdx;
    int localGroupSize = context.localGroupSizeX;
  ...
  public void testFloatReductionsAddGlobalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsFloatsKernelContext::floatReductionAddGlobalMemory,
                context,
                input,
                reduce) //
  ...
  public void testFloatReductionsAddLocalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsFloatsKernelContext::floatReductionAddLocalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testFloatReductionsMaxGlobalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsFloatsKernelContext::floatReductionMaxGlobalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testFloatReductionsMaxLocalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsFloatsKernelContext::floatReductionMaxLocalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testFloatReductionsMinGlobalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsFloatsKernelContext::floatReductionMinGlobalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
  ...
  public void testFloatReductionsMinLocalMemory() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsFloatsKernelContext::floatReductionMinLocalMemory,
                context,
                input,
                reduce) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, reduce);
