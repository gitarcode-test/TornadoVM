...
public class TestArrays extends TornadoTestBase {
  ...
  public static void vectorAddIntegerKernelContext(
      IntArray a, KernelContext context, IntArray b, IntArray c) {
  ...
  public void testWarmUp() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < N; i++) {
      assertThat(i + numKernels, equalTo(data.get(i)));
    }
  }
  ...
  public void testInitByteArray() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < N; i++) {
      assertThat((byte) 21, equalTo(data.get(i)));
    }
  }
  ...
  public void testInitNotParallel() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < N; i++) {
      assertThat((double) 1f, closeTo(data.get(i), 0.0001));
    }
  }
  ...
  public void testAdd() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < N; i++) {
      assertThat((double) i + numKernels, closeTo(data.get(i), 0.0001));
    }
  }
  ...
  public void testVectorAdditionDouble() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < c.getSize(); i++) {
      assertThat((double) a.get(i) + b.get(i), closeTo(c.get(i), 0.01));
    }
  }
  ...
  public void testVectorAdditionFloat() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < c.getSize(); i++) {
      assertThat((double) a.get(i) + b.get(i), closeTo(c.get(i), 0.01f));
    }
  }
  ...
  public void testHalfFloatInitialization() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < c.getSize(); i++) {
      assertThat((double) 100.0f, closeTo(c.get(i).getFloat32(), 0.01f));
    }
  }
  ...
  public void testVectorAdditionHalfFloat() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < c.getSize(); i++) {
      assertThat((double) 8.0f, closeTo(c.get(i).getFloat32(), 0.01f));
    }
  }
  ...
  public void testVectorSubtractionHalfFloat() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < c.getSize(); i++) {
      assertThat((double) 4.0f, closeTo(c.get(i).getFloat32(), 0.01f));
    }
  }
  ...
  public void testVectorMultiplicationHalfFloat() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < c.getSize(); i++) {
      assertThat((double) 12.0f, closeTo(c.get(i).getFloat32(), 0.01f));
    }
  }
  ...
  public void testVectorDivisionHalfFloat() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < c.getSize(); i++) {
      assertThat((double) 3.0f, closeTo(c.get(i).getFloat32(), 0.01f));
    }
  }
  ...
  public void testVectorCharsMessage() throws TornadoExecutionPlanException {
    ...
    assertThat('w', equalTo(a.get(0)));
    assertThat('o', equalTo(a.get(1)));
    assertThat('r', equalTo(a.get(2)));
    assertThat('l', equalTo(a.get(3)));
    assertThat('d', equalTo(a.get(4)));
    assertThat('!', equalTo(a.get(5)));
  }
  // CHECKSTYLE:ON
