...
public class TestGrid extends TornadoTestBase {
  ...
  public void testDynamicGrid02() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < numElements; i++) {
      for (int j = 0; j < numElements; j++) {
        assertThat((double) seq.get(i * numElements + j), closeTo(c.get(i * numElements + j), 0.1f));
      }
    }
  }
  ...
  /** Test with multiple tasks within a task-scheduler sharing the same worker grid. */
  @Test
