...
public class TestMatrices extends TornadoTestBase {
  ...
  public static void matrixAddition1D(
      float[] matrixA, float[] matrixB, float[] result, final int size) {
    for (@Parallel int i = 0; i < size; i++) {
      for (int j = 0; j < size; j++) {
  ...
  public static void matrixAddition2D(
      float[] matrixA, float[] matrixB, float[] result, final int size) {
    for (@Parallel int i = 0; i < size; i++) {
      for (@Parallel int j = 0; j < size; j++) {
  ...
  public static void matrixMultiplication(
      final float[] A, final float[] B, final float[] C, final int size) {
    for (@Parallel int i = 0; i < size; i++) {
      for (@Parallel int j = 0; j < size; j++) {
        float sum = 0.0f;
  ...
  public static void matrixMultiplicationParallelInduction(
      final float[] A, final float[] B, final float[] C, final int size) {
    for (@Parallel int i = 0; i < size; i++) {
      for (int j = 0; j < i; j++) {
        float sum = 0.0f;
  ...
  public static void matrixUsageOfParallelInduction(
      final float[] A, final float[] B, final float[] C, final int size) {
    for (@Parallel int i = 0; i < size; i++) {
      for (int j = 0; j < i; j++) {
        float sum = 0.0f;
  ...
  public void testMatrixVectorSmall() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < vector.length; i++) {
      assertThat(resultSeq[i], closeTo(result[i], 0.01f));
    }
  }
  ...
  public void testMatrixInit1DSmall() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < matrix.length; i++) {
      assertThat(resultSeq[i], closeTo(matrix[i], 0.01f));
    }
  }
  ...
  public void testCopyMatrix2D() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < N; i++) {
      for (int j = 0; j < N; j++) {
        assertThat(matrixA[i][j], closeTo(matrixB[i][j], 0.01));
      }
    }
  }
  ...
  public void testMatrixMultiplicationSmall() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < N; i++) {
      for (int j = 0; j < N; j++) {
        assertThat(resultSeq[i * N + j], closeTo(matrixC[i * N + j], 0.1));
      }
    }
  }
  ...
  public void testParallelInductionVariablesAsBounds() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestMatrices::matrixMultiplicationParallelInduction,
                matrixA,
                matrixB,
                matrixC,
                N) //
    ...
    for (int i = 0; i < N; i++) {
      for (int j = 0; j < N; j++) {
        assertThat(resultSeq[i * N + j], closeTo(matrixC[i * N + j], 0.1f));
      }
    }
  }
  ...
  public void testMultipleParallelInductionVariableLoopUsage()
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestMatrices::matrixUsageOfParallelInduction,
                matrixA,
                matrixB,
                matrixC,
                N) //
  ...
  public void testAddMatrix() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < matrix.length; i++) {
      MatcherAssert.assertArrayEquals(matrixSeq[i], matrix[i]);
    }
  }
  ...
  public void testAddMatrixMultiple() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < firstMatrix.length; i++) {
      MatcherAssert.assertArrayEquals(firstMatrixSeq[i], firstMatrix[i], 0.01f);
    }
  }
  // CHECKSTYLE:ON
}
