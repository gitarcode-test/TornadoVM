...
public class TestBatches extends TornadoTestBase {
  ...
  public void test100MBSmall() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      executionPlan
          .withBatch("60MB") // Slots of 100 MB
          .execute();
    }

    for (int i = 0; i < arrayB.getSize(); i++) {
      assertThat((double) arrayA.get(i) + 100, closeTo(arrayB.get(i), 0.1f));
    }
  }
  ...
  public void test100MBSmallLazy() throws TornadoExecutionPlanException {
    ...
    ImmutableTaskGraph immutableTaskGraph = taskGraph.snapshot();
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      TornadoExecutionResult tornadoExecutionResult =
          executionPlan
              .withBatch("60MB") // Slots of 100 MB
              .execute();
  ...
  public void test100MB() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      executionPlan
          .withBatch("100MB") // Slots of 100 MB
          .execute();
    }
  ...
  public void test300MB() throws TornadoExecutionPlanException {
    ...
    Random r = new Random();
    IntStream.range(0, arrayA.getSize())
        .sequential()
        .forEach(idx -> arrayA.set(idx, r.nextFloat()));
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      executionPlan
          .withBatch("300MB") // Slots of 300 MB
          .execute();
    }

    for (int i = 0; i < arrayB.getSize(); i++) {
      assertThat((double) arrayA.get(i) + 100, closeTo(arrayB.get(i), 1.0f));
    }
  }
  ...
  public void test512MB() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      executionPlan
          .withBatch("512MB") // Slots of 512 MB
          .execute();
    }

    for (int i = 0; i < arrayA.getSize(); i++) {
      assertThat((double) i, closeTo(arrayA.get(i), 0.1f));
    }
  }
  ...
  public void test50MB() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      executionPlan
          .withBatch("50MB") // Slots of 50 MB
          .execute();
    }

    for (int i = 0; i < arrayA.getSize(); i++) {
      assertThat((double) arrayA.get(i) + arrayB.get(i), closeTo(arrayC.get(i), 0.1f));
    }
  }
  ...
  public void test50MBInteger() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < arrayA.getSize(); i++) {
      assertThat((arrayA.get(i) + arrayB.get(i)), equalTo(arrayC.get(i)));
    }
  }
  ...
  public void test50MBDouble() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < arrayA.getSize(); i++) {
      assertThat((double) arrayA.get(i) + arrayB.get(i), closeTo(arrayC.get(i), 0.01));
    }
  }
  ...
  public void testSameInputSize() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < a1.getSize(); i++) {
      assertThat((double) a0.get(i), closeTo(a1.get(i), 1e-20));
    }
  }
  ...
  public void testSameInputSizeJavaArrays() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < a1.length; i++) {
      assertThat((double) a0[i], closeTo(a1[i], 1e-20));
    }
  }
  ...
  public void testSameInputSizeJavaToTornado() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < a1.getSize(); i++) {
      assertThat((double) a0[i], closeTo(a1.get(i), 1e-20));
    }
  }
  ...
  public void testSameInputSizeTornadoToJava() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < a1.length; i++) {
      assertThat((double) a0.get(i), closeTo(a1[i], 1e-20));
    }
  }
  ...
  public void testSameInputSizeAndTypeJavaToTornado() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < a1.getSize(); i++) {
      assertThat(a0[i], equalTo(a1.get(i)));
    }
  }
  ...
  public void testSameInputSizeAndTypeTornadoToJava() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < a1.length; i++) {
      assertThat(a0.get(i), equalTo(a1[i]));
    }
  }
  ...
  public void testBatchNotEven() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(taskGraph.snapshot())) {
      executionPlan
          .withBatch("10MB") // Batches of 10MB
          .execute();
    }

    for (int i = 0; i < array.getSize(); i++) {
      assertThat((double) arraySeq.get(i) * 2, closeTo(array.get(i), 0.01f));
    }
  }
  ...
  public void testBatchNotEven2() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < array.getSize(); i++) {
      assertThat((double) array2.get(i) * 4, closeTo(array.get(i), 0.01f));
    }
  }
  ...
  public void testBatchThreadIndex() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < array.getSize(); i++) {
      assertThat((double) arraySeq.get(i), closeTo(array.get(i), 0.01f));
    }
  }

  private long checkMaxHeapAllocationOnDevice(int size, MemoryUnit memoryUnit)
      throws UnsupportedConfigurationException {
    long maxAllocMemory =
        getTornadoRuntime().getDefaultDevice().getDeviceContext().getMemoryManager().getHeapSize();
