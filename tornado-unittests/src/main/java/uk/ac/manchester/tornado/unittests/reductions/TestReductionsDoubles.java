...
public class TestReductionsDoubles extends TornadoTestBase {
  ...
  public void testSumDoubles() throws TornadoExecutionPlanException {
    ...
    assertThat(sequential.get(0), closeTo(result.get(0), 0.01f));
  }
  ...
  private static void reductionAddDoubles4(
      DoubleArray inputA, DoubleArray inputB, @Reduce DoubleArray result) {
    double error = 2f;
    result.set(0, 0.0f);
  ...
  public void testSumDoubles3() throws TornadoExecutionPlanException {
    ...
    assertThat(sequential.get(0), closeTo(result.get(0), 0.1f));
  }
  ...
  public void testMaxReduction() throws TornadoExecutionPlanException {
    ...
    assertThat(sequential.get(0), closeTo(result.get(0), 0.01));
  }
  ...
  private static void prepareTornadoSumForMeanComputation(
      final DoubleArray values, @Reduce DoubleArray result) {
    result.set(0, 0.0f);
    for (@Parallel int i = 0; i < values.getSize(); i++) {
  ...
  private static void computeMapWithReduceValue(
      final DoubleArray values, @Reduce DoubleArray result) {
    for (@Parallel int i = 0; i < values.getSize(); i++) {
  ...
  public void testMultipleReductions() throws TornadoExecutionPlanException {
    ...
    IntStream.range(0, data.getSize())
        .forEach(
            idx -> {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsDoubles::prepareTornadoSumForMeanComputation,
                data,
                reduceResult) //
    ...
    for (int i = 0; i < data.getSize(); i++) {
      assertThat(sequentialResult.get(i), closeTo(data.get(i), 0.01f));
    }
  }

  private static void computeStandardDeviation(
      final DoubleArray values, final DoubleArray sum, @Reduce final DoubleArray std) {
  ...
  public void testMultipleReductions2() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t1",
                TestReductionsDoubles::computeStandardDeviation,
                data2,
                resultSum,
                resultStd) //
    ...
    assertThat(sequentialStd.get(0), closeTo(resultStd.get(0), 0.01));
  }
  ...
  public void testMultipleReductions3() throws TornadoExecutionPlanException {
    ...
    assertThat(sequentialSum.get(0), closeTo(resultSum.get(0), 0.01));
    assertThat(sequentialStd.get(0), closeTo(resultStd.get(0), 0.01));
  }

  private static void maxReductionAnnotation2(
      DoubleArray input, @Reduce DoubleArray result, double neutral) {
  ...
  public void testMultipleReductions4() throws TornadoExecutionPlanException {
    ...
    Random r = new Random();
    IntStream.range(0, data1.getSize())
        .forEach(
            idx -> {
    ...
    IntStream.range(0, data2.getSize())
        .forEach(
            idx -> {
    ...
    assertThat(sequentialStd1.get(0), closeTo(resultStd1.get(0), 0.01));
    assertThat(sequentialStd2.get(0), closeTo(resultStd2.get(0), 0.01));
  }
  ...
  public void testMultipleReductions5() throws TornadoExecutionPlanException {
    ...
    IntStream.range(0, data3.getSize())
        .forEach(
            idx -> {
    ...
    assertThat(sequentialStd1.get(0), closeTo(resultStd1.get(0), 0.01));
    assertThat(sequentialStd2.get(0), closeTo(resultStd2.get(0), 0.01));
    assertThat(sequentialStd3.get(0), closeTo(resultStd3.get(0), 0.01));
  }
  ...
  public void testMinReduction2() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                TestReductionsDoubles::minReductionAnnotation2,
                input,
                result,
                Double.MAX_VALUE) //
            .transferToHost(DataTransferMode.EVERY_EXECUTION, result);
