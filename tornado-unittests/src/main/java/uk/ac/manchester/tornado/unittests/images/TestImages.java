...
public class TestImages extends TornadoTestBase {
  ...
  public void testImageFloat01() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        assertThat(1f, closeTo(image.get(i, j), 0.001));
      }
    }
  }
  ...
  public void testImageFloat04() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        assertThat(100f, closeTo(imageB.get(i, j), 0.001));
      }
    }
  }
  ...
  public void testImageFloat07() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat(10f, closeTo(result.getX(), 0.001));
        assertThat(20f, closeTo(result.getY(), 0.001));
        assertThat(30f, closeTo(result.getZ(), 0.001));
      }
    }
  }
  ...
  public void testImageFloat09() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat(20f, closeTo(result.getY(), 0.001));
        assertThat(30f, closeTo(result.getZ(), 0.001));
        assertThat(40f, closeTo(result.getW(), 0.001));
      }
    }
  }
  ...
  public void testImageFloat11() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat(10f, closeTo(result.getS0(), 0.001));
        assertThat(20f, closeTo(result.getS1(), 0.001));
        assertThat(30f, closeTo(result.getS2(), 0.001));
        assertThat(40f, closeTo(result.getS3(), 0.001));
        assertThat(50f, closeTo(result.getS4(), 0.001));
        assertThat(60f, closeTo(result.getS5(), 0.001));
        assertThat(70f, closeTo(result.getS6(), 0.001));
        assertThat(80f, closeTo(result.getS7(), 0.001));
      }
    }
  }
  ...
  public void testImageFloat12() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat(10f, closeTo(result.getX(), 0.001));
        assertThat(11f, closeTo(result.getY(), 0.001));
        assertThat(12f, closeTo(result.getZ(), 0.001));
      }
    }
  }
  ...
  public void testImageFloat14() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat(11f, closeTo(result.getY(), 0.001));
        assertThat(12f, closeTo(result.getZ(), 0.001));
        assertThat(13f, closeTo(result.getW(), 0.001));
      }
    }
  }
  ...
  public void testImageFloat16() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      ...
      while (iteration < 10000) {
        ...
        for (int i = 0; i < M; i++) {
          for (int j = 0; j < N; j++) {
            assertThat((11 + iteration), closeTo(imageB.get(i, j), 0.1f));
          }
        }
  ...
  public void testImageFloat18() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      ...
      while (iteration < 10000) {
        ...
        for (int i = 0; i < M; i++) {
          for (int j = 0; j < N; j++) {
            assertThat((base + 0.01f), closeTo(imageB.get(i, j), 0.01f));
          }
        }
        base += 0.01f;
