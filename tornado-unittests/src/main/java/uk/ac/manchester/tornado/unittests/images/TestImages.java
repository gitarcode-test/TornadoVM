...
public class TestImages extends TornadoTestBase {
  ...
  public void testImageFloat01() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        assertThat((double) image.get(i, j), closeTo(1f, 0.001));
      }
    }
  }
  ...
  /**
   * Test for computing a referenced method using {@link ImageFloat} on the OpenCL device using
   * square-matrices.
   */
  @Test
  public void testImageFloat04() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        assertThat((double) imageB.get(i, j), closeTo(100f, 0.001));
      }
    }
  }
  ...
  /**
   * Test for computing a referenced method using {@link ImageFloat} on the OpenCL device using
   * non-square matrices and small size.
   */
  @Test
  ...
  /**
   * Test for computing a referenced method using {@link ImageFloat} on the OpenCL device using
   * non-square matrices with big size.
   */
  @Test
  ...
  public void testImageFloat07() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat((double) result.getX(), closeTo(10f, 0.001));
        assertThat((double) result.getY(), closeTo(20f, 0.001));
        assertThat((double) result.getZ(), closeTo(30f, 0.001));
      }
    }
  }
  ...
  public void testImageFloat09() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat((double) result.getY(), closeTo(20f, 0.001));
        assertThat((double) result.getZ(), closeTo(30f, 0.001));
        assertThat((double) result.getW(), closeTo(40f, 0.001));
      }
    }
  }
  ...
  public void testImageFloat11() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat((double) result.getS0(), closeTo(10f, 0.001));
        assertThat((double) result.getS1(), closeTo(20f, 0.001));
        assertThat((double) result.getS2(), closeTo(30f, 0.001));
        assertThat((double) result.getS3(), closeTo(40f, 0.001));
        assertThat((double) result.getS4(), closeTo(50f, 0.001));
        assertThat((double) result.getS5(), closeTo(60f, 0.001));
        assertThat((double) result.getS6(), closeTo(70f, 0.001));
        assertThat((double) result.getS7(), closeTo(80f, 0.001));
      }
    }
  }
  ...
  public void testImageFloat12() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat((double) result.getX(), closeTo(10f, 0.001));
        assertThat((double) result.getY(), closeTo(11f, 0.001));
        assertThat((double) result.getZ(), closeTo(12f, 0.001));
      }
    }
  }
  ...
  public void testImageFloat14() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < M; i++) {
      for (int j = 0; j < N; j++) {
        ...
        assertThat((double) result.getY(), closeTo(11f, 0.001));
        assertThat((double) result.getZ(), closeTo(12f, 0.001));
        assertThat((double) result.getW(), closeTo(13f, 0.001));
      }
    }
  }
  ...
  public void testImageFloat16() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      ...
      while (iteration < 10000) {
        ...
        for (int i = 0; i < M; i++) {
          for (int j = 0; j < N; j++) {
            assertThat((double) imageB.get(i, j), closeTo((11 + iteration), 0.1f));
          }
        }
  ...
  public void testImageFloat18() throws TornadoExecutionPlanException {
    ...
    try (TornadoExecutionPlan executionPlan = new TornadoExecutionPlan(immutableTaskGraph)) {
      ...
      while (iteration < 10000) {
        ...
        for (int i = 0; i < M; i++) {
          for (int j = 0; j < N; j++) {
            assertThat((double) imageB.get(i, j), closeTo((base + 0.01f), 0.01f));
          }
        }
        base += 0.01f;
