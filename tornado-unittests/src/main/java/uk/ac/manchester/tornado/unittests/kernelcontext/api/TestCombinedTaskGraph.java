...
/**
 * The unit-tests in this class check that TornadoVM TaskSchedule API can combine multiple tasks,
 * which can either exploit the {@link KernelContext} features or adhere to the original TornadoVM
 * annotations {@link uk.ac.manchester.tornado.api.annotations.Parallel} or {@link
 * uk.ac.manchester.tornado.api.annotations.Reduce}.
 *
 * <p>The following tests implement a single TaskSchedule that has three consecutive tasks: t0:
 * Vector Addition, t1: Vector Multiplication and t2: Vector Subtraction.
 *
 * <p>How to run? <code>
...
public class TestCombinedTaskGraph extends TornadoTestBase {
  ...
  /**
   * Method that performs the vector addition of two arrays and stores the result in a third array.
   * This method uses the {@link uk.ac.manchester.tornado.api.annotations.Parallel} annotation.
   *
   * @param a input array
   * @param b input array
  ...
  /**
   * Method that performs the vector addition of two arrays and stores the result in a third array.
   * This method uses the {@link KernelContext} thread identifier.
   *
   * @param a input array
   * @param b input array
   * @param c output array
  ...
  /**
   * Method that performs the vector multiplication of two arrays and stores the result in a third
   * array. This method uses the {@link uk.ac.manchester.tornado.api.annotations.Parallel}
   * annotation.
   *
   * @param a input array
   * @param b input array
  ...
  /**
   * Method that performs the vector multiplication of two arrays and stores the result in a third
   * array. This method uses the {@link KernelContext} thread identifier.
   *
   * @param a input array
   * @param b input array
   * @param c output array
  ...
  /**
   * Method that performs the vector subtraction of two arrays and stores the result in a third
   * array. This method uses the {@link uk.ac.manchester.tornado.api.annotations.Parallel}
   * annotation.
   *
   * @param a input array
  ...
  /**
   * In this test, all tasks use the TaskSchedule API, and only t0 uses the {@link GridScheduler}
   * and {@link WorkerGrid} to deploy a specific number of threads.
   */
  @Test
  ...
  /**
   * In this test, all tasks use the {@link KernelContext} within the TaskSchedule API, and all
   * tasks share the same {@link GridScheduler} and {@link WorkerGrid} to deploy a specific number
   * of threads.
   */
  @Test
  ...
  /**
   * In this test, all tasks use the {@link KernelContext} within the TaskSchedule API, and tasks t1
   * and t2 share the same {@link GridScheduler} and {@link WorkerGrid} to deploy a specific number
   * of threads.
   */
  @Test
  ...
  /**
   * In this test, t0 and t1 use the {@link KernelContext} within the TaskSchedule API, and share
   * the same {@link GridScheduler} and {@link WorkerGrid} to deploy a specific number of threads.
   * While, t2 uses the TaskSchedule API.
   */
  @Test
  ...
  /**
   * In this test, t0 and t1 use the {@link KernelContext} within the TaskSchedule API, and use
   * separate {@link GridScheduler} and {@link WorkerGrid} to deploy different number of threads.
   * While, t2 uses the TaskSchedule API.
   */
  @Test
