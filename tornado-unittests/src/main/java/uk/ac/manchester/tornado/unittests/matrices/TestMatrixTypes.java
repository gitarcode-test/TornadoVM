...
public class TestMatrixTypes extends TornadoTestBase {
  ...
  public static void computeMatrixSum(
      Matrix3DFloat a, Matrix3DFloat b, final int X, final int Y, final int Z) {
  ...
  public static void computeMatrixSum(
      Matrix2DDouble a, Matrix2DDouble b, final int X, final int Y) {
    for (@Parallel int i = 0; i < X; i++) {
      for (@Parallel int j = 0; j < Y; j++) {
        b.set(i, j, a.get(i, j) + a.get(i, j));
      }
  ...
  public static void computeMatrixMultiplication(
      Matrix2DFloat a, Matrix2DFloat b, Matrix2DFloat c) {
   ...
   */
  public static void computeMatrixSum(
      Matrix2DFloat4 a, Matrix2DFloat4 b, final int X, final int Y) {
    for (@Parallel int i = 0; i < X; i++) {
      for (@Parallel int j = 0; j < Y; j++) {
  ...
  public static void computeMatrixSum(
      Matrix3DFloat4 a, Matrix3DFloat4 b, final int X, final int Y, final int Z) {
    for (@Parallel int i = 0; i < X; i++) {
      for (@Parallel int j = 0; j < Y; j++) {
        for (@Parallel int k = 0; k < Z; k++) {
  ...
  private static void testMatricesFloats(final int X, final int Y)
    ...
    for (int i = 0; i < X; i++) {
      for (int j = 0; j < Y; j++) {
        assertThat((double) matrixA.get(i, j) + matrixA.get(i, j), closeTo(matrixB.get(i, j), 0.01f));
      }
    }
  }
  ...
  private static void testMatrixDoubles(final int X, final int Y)
    ...
    for (int i = 0; i < X; i++) {
      for (int j = 0; j < Y; j++) {
        assertThat((double) matrixA.get(i, j) + matrixA.get(i, j), closeTo(matrixB.get(i, j), 0.01));
      }
    }
  }
  ...
  public void testMatrixRowInt01() {
    ...
    assertThat((double) 1f, closeTo(row0.getArray().get(0), 0.01f));
    assertThat((double) 2f, closeTo(row0.getArray().get(1), 0.01f));
    assertThat((double) 3f, closeTo(row1.getArray().get(0), 0.01f));
    assertThat((double) 4f, closeTo(row1.getArray().get(1), 0.01f));
    assertThat((double) 5f, closeTo(row2.getArray().get(0), 0.01f));
    assertThat((double) 6f, closeTo(row2.getArray().get(1), 0.01f));
  }
  ...
  public void testMatrixRowInt02() {
    ...
    assertThat((double) 1f, closeTo(row0.getArray().get(0), 0.01f));
    assertThat((double) 2f, closeTo(row0.getArray().get(1), 0.01f));
    assertThat((double) 3f, closeTo(row0.getArray().get(2), 0.01f));
    assertThat((double) 4f, closeTo(row1.getArray().get(0), 0.01f));
    assertThat((double) 5f, closeTo(row1.getArray().get(1), 0.01f));
    assertThat((double) 6f, closeTo(row1.getArray().get(2), 0.01f));
  }
  ...
  /**
   * Tests testMatrix01-testMatrix06 had to be moved before the tests for float matrices. The reason
   * is that when they were executed at a later stage (after testMatrix21), the plugin for
   * MemorySegment (getAtIndex) was not being invoked.
   */
  @Test
  ...
  public void testMatrix09() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < N; i++) {
      for (int j = 0; j < N; j++) {
        assertThat((double) sequential.get(i, j), closeTo(matrixC.get(i, j), 0.01f));
      }
    }
  }
  ...
  public void testMatrix10() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < N; i++) {
      for (int j = 0; j < N; j++) {
        for (int k = 0; k < N; k++) {
          assertThat((double) matrixA.get(i, j, k) + matrixA.get(i, j, k), closeTo(matrixB.get(i, j, k), 0.01f));
        }
      }
    }
  }
  ...
  public void testMatrix17() throws TornadoExecutionPlanException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s9") //
            ...
            .task(
                "t9",
                TestMatrixTypes::computeMatrixSum,
                matrixA,
                matrixB,
                SMALL_SIZE,
                SMALL_SIZE,
