...
public class TestDoubles extends TornadoTestBase {
  ...
  public void testDoubleAdd2() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      assertThat((double) output.get(i), closeTo(8.0, DELTA));
    }
  }
  ...
  public void testDoubleAdd3() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      assertThat((double) output.get(i), closeTo(12.0, DELTA));
    }
  }
  ...
  public void testDoubleAdd4() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      assertThat((double) output.get(i), closeTo(20.0, DELTA));
    }
  }
  ...
  public void testDoubleAdd8() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      assertThat((double) output.get(i), closeTo(72., DELTA));
    }
  }
  ...
  public void testDoubleAdd() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      assertThat((double) output.get(i), closeTo(i + i, DELTA));
    }
  }
  ...
  public void testVectorDouble4() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      Double4 sequential =
          new Double4(i + (size - i), i + (size - i), i + (size - i), i + (size - i));
      assertThat((double) output.get(i).getX(), closeTo(sequential.getX(), DELTA));
      assertThat((double) output.get(i).getY(), closeTo(sequential.getY(), DELTA));
      assertThat((double) output.get(i).getZ(), closeTo(sequential.getZ(), DELTA));
  ...
  public void testVectorDouble8() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      ...
      b.set(
          i,
          new Double8(
              size - i, size - i, size - i, size - i, size - i, size - i, size - i, size - i));
    }
    ...
    for (int i = 0; i < size; i++) {
      ...
      for (int j = 0; j < 8; j++) {
        assertThat((double) output.get(i).get(j), closeTo(sequential.get(j), DELTA));
      }
    }
  }
